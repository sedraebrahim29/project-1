        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 15.h),
              Text('${AppStrings.professionalEmail(context)} ${AppStrings.optional(context)}', style: TextStyle(fontSize: 13.sp, fontWeight: FontWeight.w500)),
              SizedBox(height: 6.h),
              TextFormField(
                initialValue: state.model.professionalEmail,
                keyboardType: TextInputType.emailAddress,
                decoration: InputDecoration(
                  hintText: AppStrings.emailHint(context),
                ...
                onChanged: (value) {
                  cubit.updateRegisterModel(state.model.copyWith(professionalEmail: value));
                },
              ),
              SizedBox(height: 15.h),
              ...
              TextFormField(
                ...
                validator: (val) {
                   ...
                   if (val != state.model.password) return AppStrings.passwordsDoNotMatch(context);
                   return null;
                },
                decoration: InputDecoration(
                  hintText: AppStrings.passwordHint(context),
